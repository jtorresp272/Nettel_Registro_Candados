...
class CustomResumen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
      child: Padding(
        padding: const EdgeInsets.all(10.0),//EdgeInsets.symmetric(vertical:MediaQuery.of(context).size.height*0.15),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.center,
          children: [
            _CustomContainer(razon: 'Candados Operativos',dato: datosTaller['Candados Operativos']),
            _CustomContainer(razon: 'Mecanicas Listas',dato: datosTaller['Mecanicas Listas']),
            _CustomContainer(razon: 'Candados Ingresados',dato: datosTaller['Candados Ingresados']),
            _CustomContainer(razon: 'Mecanicas Dañadas',dato: datosTaller['Mecanicas Dañadas']),
            _CustomContainer(razon: 'Total mecanicas en taller',dato: datosTaller['Total mecanicas en taller']),
            _CustomContainer(razon: 'Total mecanicas por llegar',dato: listaLlegar.length),
          ],
        ),
      ),
    );
    ...
    child: Row(
      children: [
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(10.0), // Mitad del ancho o altura para bordes redondeados completos
        ),
        child: Text('${(dato!= null) ? dato:0}',
