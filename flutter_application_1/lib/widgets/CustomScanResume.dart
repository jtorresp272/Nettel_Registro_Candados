...
class _CustomScanResumeState extends State<CustomScanResume> with SingleTickerProviderStateMixin {
  ...
  Map<String,List<Color>> color = {'V':[Colors.white,Colors.white,Colors.white,Colors.white,Colors.red.shade200,Colors.red.shade300],
  'M':[Colors.white,Colors.white,Colors.white,Colors.white,Colors.yellow.shade200,Colors.yellow.shade300],
  'L':[Colors.white,Colors.white,Colors.white,Colors.white,Colors.green.shade200,Colors.green.shade300],
  'I':[Colors.white,Colors.white,Colors.white,Colors.white,Colors.orange.shade200,Colors.orange.shade300],
  };
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        gradient: LinearGradient(
          colors:color[widget.candado.lugar] ?? [Colors.white ,Colors.white, Colors.grey.shade400, Colors.grey.shade400],
